                ...
                <div class="row">
                    ...
                    <div class="col-md-12 col-lg-12">
                        <div class="overflow-hidden card" data-aos="fade-up" data-aos-delay="600">
                            <div class="flex-wrap card-header d-flex justify-content-between">
                                <div class="header-title">
                                    <h4 class="mb-2 card-title"> Collector Availability</h4>
                                </div>
                            </div>
                            <div class="p-0 card-body">
                                <div class="mt-4 table-responsive">
                                    <table id="basic-table" class="table mb-0 table-striped" role="grid">
                                        ...
                                        <tbody>
                                            @foreach ($availableCollectors as $row)
                                                <tr>
                                                    <td>
                                                        <p>{{ $row->user->name }}</p>
                                                    </td>
                                                    <td>
                                                        <p>{{ $row->available_slots }}</p>
                                                    </td>
                                                    <td>
                                                        <a
                                                            href="{{ route('assignedbookingfor', [$row->id]) }}"class="btn btn-outline-primary btn-sm">
                                ...
                                <div class="flex-wrap card-header d-flex justify-content-between">
                                    <div class="header-title">
                                        ...
                                        <p class="mb-0">
                                            ...
                                            {{ $promonthly }} processing booking this month
                                        </p>
                                    </div>
                                </div>
                                <div class="p-0 card-body">
                                ...
                                <div class="flex-wrap card-header d-flex justify-content-between">
                                    <div class="header-title">
                                        ...
                                        <p class="mb-0">
                                            ...
                                            {{ $penmonthly }} pending booking this month
                                        </p>
                                    </div>
                                </div>
                                <div class="p-0 card-body">
                                ...
                                <div class="flex-wrap card-header d-flex justify-content-between">
                                    <div class="header-title">
                                        ...
                                        <p class="mb-0">
                                            ...
                                            {{ $accmonthly }} accepted booking this month
                                        </p>
                                    </div>
                                </div>
                                <div class="p-0 card-body">
                                ...
                                <div class="flex-wrap card-header d-flex justify-content-between">
                                    <div class="header-title">
                                        ...
                                        <p class="mb-0">
                                            ...
                                            {{ $rejmonthly }} rejected booking this month
                                        </p>
                                    </div>
                                </div>
                                <div class="p-0 card-body">
